...
func TestS3Key(t *testing.T) {
	...
	re := regexp.MustCompile(`bucket/keyprefix/year=2022/month=06/day=05/hour=00/minute=00/fileprefixlogs_([0-9]+).json`)
	s3Key := getS3Key(tm, "bucket", "keyprefix", "minute", "fileprefix", "logs", "json")
