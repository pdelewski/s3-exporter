...
func (marshaler *SumoICMarshaler) Format() string {
	return marshaler.format
}

func NewSumoICMarshaler() SumoICMarshaler {
	return SumoICMarshaler{}
}
...
func (SumoICMarshaler) MarshalTraces(traces ptrace.Traces) ([]byte, error) {
	return nil, nil
}
